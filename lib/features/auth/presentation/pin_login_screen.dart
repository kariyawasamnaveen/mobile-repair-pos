            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Stack(
                          children: [
                            const Icon(Icons.bar_chart_rounded, size: 34, color: Color(0xFFF59E0B)),
                            Positioned(
                              top: 0,
                              right: 0,
                              child: const Icon(Icons.arrow_outward_rounded, size: 16, color: Color(0xFFF59E0B)),
                            ),
                          ],
                        ),
                      ),
                ...
                if (_error != null)
                  ...
                  const SizedBox(height: 24), // Placeholder for error height
